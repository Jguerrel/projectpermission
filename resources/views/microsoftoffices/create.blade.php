...
<section class="content-header" >
            <div class="container-fluid">
                ...
                <div class="col-sm-6">
                    ...
                    <li class="breadcrumb-item active">Licencia office</li>
                    </ol>
                </div>
                </div>
            </div><!-- /.container-fluid -->
...
<div class="row justify-content-center">
    <div class="col-md-12">
        <div class="card car-info">
            ...
            <div class="card-body">
                <form action="{{ route('microsoftoffices.store') }}" method="post">
                    @csrf

                    <div class="mb-3 row">
                        <label for="name" class="col-md-4 col-form-label text-md-end text-start">Licencia Office</label>
                        <div class="col-md-6">
