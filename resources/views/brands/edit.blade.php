        ...
        <div class="card card-info card-outline">
            ...
            <div class="card-body">
                <form action="{{ route('brands.update', $brand->id) }}" method="post">
                    ...
                    @method("PUT")
                        ...
                        <div class="mb-3 row">
                            <label for="status" class="col-md-4 col-form-label text-md-right text-left">Estado</label>
                             ...
                             <div class="custom-control custom-switch mt-2"><input type="checkbox" class="custom-control-input @error('status') is-invalid @enderror" name="status" id='status' value="1" {{ $brand->status ? 'checked' : '' }} /><label class="custom-control-label" for="status">Activo</label></div>
                    ...
                    <div class="mb-3 row">
                        <input type="submit" class="col-md-3 offset-md-5 btn btn-info" value="Actualizar Marca">
                    </div>
